          ...
          <tbody>
            <div>
              ...
              <div style="padding-top: 10px;">
                ...
                <?php else : ?>
                  <form action="<?= base_url('administrativo/cursos/inscribirse/' . $curso->idCurso); ?>" method="POST">
                    <?= csrf_field() ?>
                    <input type="submit" class="btn" style="color:white;background-color: rgb(0,92,171);" value="Inscribirse">
                    <a href="<?= base_url('administrativo/perfil') ?>" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                  </form>
                <?php endif ?>
              </div>
              </p>
