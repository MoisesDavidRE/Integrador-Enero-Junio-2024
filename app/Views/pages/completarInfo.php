                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-9 col-lg-10 mx-auto">
                                <h3 class="login-heading mb-4" style="color:rgb(0,92,171)">Por favor completa tu información de usuario</h3>
                                <!-- Register Form -->
                                <form action="<?= base_url('/user/guardarInfo') ?>" method="POST">
                                    ...
                                    <strong><p>Escoge una de las siguientes preguntas, te ayudará en caso de necesitar recuperar tu contraseña</p></strong>
                                    <div class="form-group">
                                        <label>Pregunta de recuperación:</label>
                                        <select class="form-control mb-3" id="pregunta" name="pregunta" required>
                                            <option value="¿Cuál es el nombre de la primera mascota que tuviste?">¿Cuál es el nombre de la primera mascota que tuviste?</option>
                                            <option value="¿Cuál es tu libro favorito?">¿Cuál es tu libro favorito?</option>
                                            <option value="¿Cuál es tu pasatiempo favorito?">¿Cuál es tu pasatiempo favorito?</option>
                                            <option value="¿Cuál fue tu primer empleo?">¿Cuál fue tu primer empleo?</option>
                                            <option value="¿Cuál es tu comida o platillo favorito?">¿Cuál es tu comida o platillo favorito?</option>
                                            <option value="¿Cuál es el nombre de la calle donde creciste?">¿Cuál es el nombre de la calle donde creciste?</option>
                                            <option value="¿Cuál fue el nombre de tu maestr@ favorito@?">¿Cuál fue el nombre de tu maestr@ favorito@?</option>
                                            <option value="¿Cuál es el nombre de tu película favorita?">¿Cuál es el nombre de tu película favorita?</option>
                                        </select>
                                    </div>
                                    <strong><p>Asegúrate de que únicamente tú conoces la respuesta</p></strong>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="text" class="form-control" id="respuesta"
                                            name="respuesta" required>
                                        <label for="telefono">Respuesta</label>
                                    </div>
