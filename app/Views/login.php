    ...
    <div class="container-fluid ps-md-0">
        <div class="row g-0">
            ...
            <div class="flex-container d-none d-md-flex col-md-6 col-lg-8 bg-image">
                ...
                <img src="https://campus-virtual.upn212teziutlan.edu.mx/pluginfile.php/398/mod_label/intro/Fotodelauni.jpg" alt="UPN #212" width='750px' height='550px'>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto">
                                <h2 style="color:rgb(0,92,171)"><strong>¡Le damos la bienvenida!</strong></h2><br><br><br><br><br>
                                ...
                                <form action="<?= base_url('login'); ?>" method="post">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="identificador" required>
                                    ...
                                    <div class="d-grid">
                                        <button class="btn btn-lg btn-login fw-bold mb-2" type="submit" style="background-color: rgb(0, 92, 171); color: white; font-weight: bolder;">Iniciar
                                            Sesión</button>
                                    </div>
                                </form>
