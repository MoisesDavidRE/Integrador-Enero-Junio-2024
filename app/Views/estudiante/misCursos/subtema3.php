        ...
        <div class="col-md-8">
            <div class="info-box">
                ...
                <img class="img" src="https://img.freepik.com/vector-gratis/fondo-libro-ingles-dibujado-mano_23-2149483338.jpg" alt="Descripción de la imagen">  
                        <a href="<?= base_url('estudiante/misCursos/subtema2') ?>" class="btn btn-primary">Atrás</a>
                        <a href="<?= base_url('estudiante/misCursos/subtema4') ?>" class="btn btn-primary" style="margin-left: 950px;">Siguiente</a>
            </div>
        </div>
    </div>
</div>
