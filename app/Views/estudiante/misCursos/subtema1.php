...
<div class="container">
    <div class="row">
        <div class="col-md-8">
<div class="info-box">
    <div style="text-align: justify;" st>
        <?= nl2br($contenidoData->contenido) ?>
    </div>

    <img class="img" src="https://cdn.openwebinars.net/media/publications/banner/backend2.jpg" style="width: 300px;">

    <a href="<?= base_url('estudiante/misCursos') ?>" class="btn btn-primary">Atrás</a>
    <a href="<?= base_url('estudiante/misCursos/subtema2') ?>" class="btn btn-primary" style="margin-left: 950px;">Siguiente</a>
</div>
