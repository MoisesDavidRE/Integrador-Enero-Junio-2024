...
<div class="container">
    <div class="row">
        ...
        <form action="<?php echo base_url('estudiante/cursos/mostrarTema/' . $subtema->idTema); ?>" method="get">
        ...
        <div class="col-12">
            ...
            <form action="<?php echo base_url('estudiante/cursos/contenido/'.$subtema->idSubtema); ?>" method="get">
