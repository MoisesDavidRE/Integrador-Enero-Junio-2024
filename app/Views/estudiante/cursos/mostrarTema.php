...
<div class="container">
  <div class="row">
    ...
    <form action="<?php echo base_url('estudiante/cursos/editar/' . $tema->idCurso); ?>" method="get">
      ...
      <div class="row mb-5">
        <div class="col-12">
          <div class="mb-3">
            ...
            <span id="nombre" class="form-control readonly" aria-label="Nombre del tema"><?= $tema->nombre ?></span>
          </div>

          <legend>Descripción</legend>
          <textarea name="descripcion" class="form-control mb-3 readonly" aria-label="With textarea" style="height: 100px;" readonly><?= $tema->descripcion ?></textarea>

          <legend>Ilustración del tema</legend>
          <div class="contenedor-imagen">
            <img weight="200px" height="200px" src="https://cdn.pixabay.com/photo/2023/11/26/07/29/sparrow-8413000_1280.jpg" alt="Ilustración del tema <?= $tema->nombre ?>">
          </div>
        </div>
      </div>

      <form action="<?php echo base_url('estudiante/cursos/nuevoSubtema/' . $tema->idTema); ?>" method="get">
      ...
      <div class="contenedor-botones">
        <?php foreach ($subtemas as $subtema) : ?>
          ...
          <div class="tooltip-container">
            ...
            <div class="text">
              <form action="<?php echo base_url('estudiante/cursos/mostrarSubtema/' . $subtema->idSubtema); ?>" method="get">
