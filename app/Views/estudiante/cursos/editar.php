...
<div class="container">
  <div class="row">
    ...
    <div class="col-12">
      ...
      <form action="<?php echo base_url('estudiante/cursos/nuevoTema/' . $curso->idCurso); ?>" method="get">
      ...
      <div class="contenedor-botones">
        <?php foreach ($temas as $tema) : ?>
          ...
          <div class="tooltip-container">
            ...
            <div class="text">
              <form action="<?php echo base_url('estudiante/cursos/mostrarTema/' . $tema->idTema); ?>" method="get">
