    ...
    public function actualizar($id)
{
    ...
    public function insert()
    {
        ...
        // Cargar los modelos
        $usersModel = new \App\Models\UsersModel(); // Asegúrate de especificar la ubicación correcta del modelo
        $infoModel = new \App\Models\InfoModel(); // Asegúrate de especificar la ubicación correcta del modelo
