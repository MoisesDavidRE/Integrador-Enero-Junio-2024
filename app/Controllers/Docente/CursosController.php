...
class CursosController extends BaseController
{
    ...
    public function agregar()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            return view('template/main')
                . view('content')
                . view('docente/cursos/agregar', $data);
        } else {
            if ($this->insert()) {
                return redirect('docente/cursos/cursosInicio');
            }
        }
    }
    ...
    public function editar($idCurso)
    {
        ...
        return view('docente/cursos/editar', $data);
    }
    ...
    public function nuevoTema($idCurso){
        ...
        return view('docente/cursos/agregarTema',$data);
    }
    ...
    public function insertarTema()
    {
        ...
        return view('docente/cursos/editar',$dataC);
    }
    ...
    public function mostrarTema ($idTema) {
        ...
        return view('docente/cursos/mostrarTema',$data);
    }
    ...
    public function nuevoSubtema($idTema){
        ...
        return view('docente/cursos/agregarSubtema',$data);
    }
    ...
    public function insertarSubtema()
    {
        ...
        return view('docente/cursos/mostrarTema',$dataS);
    }
    ...
    public function mostrarSubtema ($idSubtema) {
        ...
        return view('docente/cursos/mostrarSubtema',$data);
    }
    ...
    public function mostrarContenido ($idSubtema) {
        ...
        return view('docente/cursos/mostrarContenido',$data);
    }
    public function inscribirse($idCurso)
    {
        ...
        return redirect('docente/misCursos');
    }
}